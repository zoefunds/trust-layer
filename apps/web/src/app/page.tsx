...
import { Shield, GitBranch, Zap, Lock, Users, ArrowRight, CheckCircle2, ChevronRight, Activity, Coins } from "lucide-react";
...
const STATS = [
  ...
  { label: "Validators Active", value: "5" },
    ...
    <div style={{ background: "#080B14", color: "#E2E8F0", minHeight: "100vh", fontFamily: "system-ui, -apple-system, sans-serif" }}>
      ...
      <section style={{ paddingTop: 140, paddingBottom: 100, paddingLeft: 24, paddingRight: 24, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: 860, margin: "0 auto", textAlign: "center", position: "relative", zIndex: 1 }}>
          ...
          <p style={{ fontSize: "clamp(1rem, 2vw, 1.2rem)", color: "#94A3B8", maxWidth: 600, margin: "0 auto 40px", lineHeight: 1.7 }}>
            TrustLayer runs 5 independent AI validators across on-chain data, GitHub, funding trails, and public records. GenLayer consensus reconciles findings into an evidence-backed trust score — in seconds.
          </p>
          ...
          <div style={{ maxWidth: 560, margin: "0 auto", borderRadius: 16, border: "1px solid #1C2333", background: "#0D1117", overflow: "hidden", boxShadow: "0 32px 80px rgba(0,0,0,0.6)" }}>
            ...
            <div style={{ padding: "20px 24px", fontFamily: "monospace", fontSize: 13, textAlign: "left" }}>
              ...
              <div style={{ marginTop: 20, paddingTop: 16, borderTop: "1px solid #1C2333" }}>
                ...
                <div style={{ fontSize: 11, color: "rgba(16,185,129,0.65)", marginTop: 4 }}>Low Risk · Consensus: 5/5 validators</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={{ padding: "80px 24px 0", position: "relative" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto", borderRadius: 20, overflow: "hidden", height: 340, position: "relative" }}>
          ...
          <img
            src="https://images.unsplash.com/photo-1639762681057-408e52192e55?w=1400&q=80"
            alt="Web3 blockchain verification network"
          ...
          <div style={{ position: "absolute", inset: 0, display: "flex", alignItems: "center", justifyContent: "center", textAlign: "center" }}>
            <div>
              ...
              <h2 style={{ fontSize: "clamp(1.8rem, 4vw, 3rem)", fontWeight: 800, letterSpacing: "-0.03em", color: "#fff", textShadow: "0 4px 40px rgba(0,0,0,0.8)" }}>
                The Trust Layer for Web3
              </h2>
              <p style={{ fontSize: 16, color: "rgba(226,232,240,0.7)", maxWidth: 520, margin: "12px auto 0", lineHeight: 1.7 }}>
                Every investment decision deserves verifiable, AI-backed evidence
              </p>
            </div>
          </div>
        </div>
      ...
      <section style={{ padding: "96px 24px" }}>
        <div style={{ maxWidth: 1100, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 20 }}>
            {[
              {
                step: "01", title: "Evidence Collection",
                desc: "TrustLayer pulls data from GitHub, DefiLlama, CoinGecko, Etherscan, and public records simultaneously.",
                accent: "#2563EB",
                img: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=600&q=80",
              },
              {
                step: "02", title: "Independent Validators",
                desc: "5 specialized AI validators run in parallel — each analyzing a distinct domain without influencing others.",
                accent: "#10B981",
                img: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=600&q=80",
              },
              {
                step: "03", title: "Consensus Engine",
                desc: "GenLayer's consensus mechanism reconciles validator findings into confidence-scored, evidence-backed results.",
                accent: "#F59E0B",
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center" }}>
            <div>
              ...
              <p style={{ fontSize: 15, color: "#64748B", lineHeight: 1.8, marginBottom: 32 }}>
                5 specialized validators analyze distinct domains simultaneously. No single point of failure — each runs independently and consensus is reached through GenLayer's verification protocol.
              </p>
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                {VALIDATORS.map((v) => {
                  const Icon = v.icon;
                  return (
                    <div key={v.label} style={{ display: "flex", alignItems: "center", gap: 12, borderRadius: 10, border: "1px solid #1C2333", background: "#080B14", padding: "12px 16px" }}>
            ...
            <div style={{ borderRadius: 16, overflow: "hidden", height: 440, position: "relative" }}>
              ...
              <img
                ...
                alt="DeFi protocol verification"
              ...
              <div style={{ position: "absolute", bottom: 20, left: 20, right: 20 }}>
                <div style={{ borderRadius: 12, background: "rgba(8,11,20,0.85)", border: "1px solid #1C2333", padding: "14px 18px", backdropFilter: "blur(10px)" }}>
                  <div style={{ fontSize: 11, color: "#64748B", fontFamily: "monospace", marginBottom: 6 }}>CONSENSUS REACHED</div>
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    <div style={{ fontSize: 28, fontWeight: 800, color: "#10B981" }}>87.4</div>
                    <div>
                      <div style={{ fontSize: 12, fontWeight: 600, color: "#10B981" }}>Low Risk</div>
                      <div style={{ fontSize: 11, color: "#64748B" }}>5/5 validators agreed</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48, alignItems: "center", marginBottom: 60 }}>
            ...
            <div>
              ...
              <p style={{ fontSize: 15, color: "#64748B", lineHeight: 1.7 }}>
                TrustLayer is designed to be queried by other platforms — not just humans. Integrate AI-consensus trust scores directly into your product.
              </p>
            </div>
          </div>
      ...
      <section style={{ position: "relative", height: 260, overflow: "hidden" }}>
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="https://images.unsplash.com/photo-1518546305927-5a555bb7020d?w=1600&q=80"
          alt="DeFi finance blockchain"
